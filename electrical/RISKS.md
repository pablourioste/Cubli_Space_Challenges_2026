...
| RE6 | Board outline late to Neisa | E2.4 slips past 1 Aug | C5 mass freeze slips, C11 frame print slips, cascades to the 9 Aug G5 gate | H | M | Pablo | E2 block starts 29 Jul with 2 days of float. If E1 slips, the outline is issued from the layout study with conservative keep-outs rather than delayed |
...
RE13 & Vibration loosens connectors & Sustained running at ${\approx}\,\qty{7000}{\rpm}$ & Intermittent axis dropout; cube falls and damages structure & M & H & Pablo & Strain relief, labelling and connector retention; reseat check as the first action of every support call \\
