# Procurement â€” Items Not in the Supplied BOM
...
| [ ] | Filament, PET-CF | â€” | Reaction wheels (130 mm ring + spokes) | M | todo |
| [ ] | Filament, PETG / TPU | â€” | Printed structure and brackets | L | todo |
...
## Electrical / power â€” mine

| # | Item | Qty | Driven by | Risk | State |
|---|---|---|---|---|---|
| [ ] | Bus bulk capacitor, 470-1000 uF, >= 50 V, low-ESR | 1 | Regen-braking transient, 89 J/wheel at 6000 rpm | L | todo |
| [ ] | XT30 connector pairs | 4+ | moteus-n1 power connector; BOM supplies XT60 only | L | todo |
...
## Bench / safety â€” mine, needed before any bring-up
...
therefore not a procurement item but an accepted risk â€” see RE11 in
...
2. Bulk capacitor lead time â€” E4.2 on 3 Aug depends on it.
