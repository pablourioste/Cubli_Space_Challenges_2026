...
% The drawing sheet is landscape and is reproduced on a dedicated landscape page
% at full width, so the views and the title block stay legible. The empty page
% style suppresses the rotated running header and footer, as on the Gantt sheets
% of Sec. 2; \thispagestyle overrides the float page's own \plain.
\begin{landscape}
\pagestyle{cubligantt}
\begin{figure}[p]
\thispagestyle{cubligantt}
\centering
\includegraphics[width=\linewidth]{images/1D_2dwg.pdf}
