...
Table~\ref{tab:massbudget}, which is the input to the sizing verification of
Section~\ref{sec:sizing_verification} and must be re-run whenever it changes.
...
per Section~\ref{sec:sizing_verification}; where it does not, the finding returns to
