...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.67\textwidth, angle=-90]{images/cube_3D.jpeg}
\caption[Final assembled three-axis cube frame]{Final assembled 
three-axis cube frame, showing the X-braced outer faces and the 
three orthogonal reaction-wheel modules carried by the inner structure. This 
hardware represents the finalized two-part architecture and internal packaging, 
incorporating the final wheel geometry and frame edge length $L$ established by the 
sizing closure of Sections~\ref{sec:massbudget} and~\ref{sec:rw_sizing}. 
The frozen design's general-assembly drawing is given in 
Figure~\ref{fig:dwg_3d} of Appendix~\ref{app:cad_3d}.}
\label{fig:cube_3d}
\end{figure}
