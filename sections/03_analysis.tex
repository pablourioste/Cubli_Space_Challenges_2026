...
Since this is a proof-of-concept demonstration of the control loop which could be applicable for a smallsat ADCS, a system actuated with orthogonal reaction wheels is much more relevant than a more complex system such as with control moment gyros. Reaction wheels are much simpler structurally and require less specialized components. For low-cost smallsats, a control loop 
