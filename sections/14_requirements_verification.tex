...
PER-12 & A, T & Compute $t_{\text{spin}} = I_w\omega_{\max}/k_ti$ from the measured torque constant; confirm on the built wheel by logging speed against time through a spin-up at the continuous current limit (WBS E10). & Design speed reached within \qty{2}{\second} without exceeding \qty{9}{\ampere}. & Open (analysis: \qty{1.3}{\second}) \\
PER-13 & A, T & Compare the commanded spin-up torque against $\tau_g=MgL/2$ at the as-built mass; observe the body on a face rest through a full spin-up. & Reaction torque $\leq 0.5\,\tau_g$; no body motion before the brake event. & Open (analysis: \qty{15.7}{\percent}) \\
\midrule
