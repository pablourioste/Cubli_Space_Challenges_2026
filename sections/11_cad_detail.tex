...
part carries a duplicated hard-coded value. Values are drawn from the
specification sheet of Appendix~\ref{app:specs}.}
...
\midrule
$L$         & Cube edge length (outer)                & \qty{\cubeL}{\milli\metre} \\
$t_w$       & Frame wall thickness                    & \qty{\cubeWall}{\milli\metre} \\
$D_w$       & Wheel outer diameter (Sec.~\ref{sec:rw_sizing}) & \qty{\wheelOD}{\milli\metre} \\
$t_r$       & Wheel axial thickness (Sec.~\ref{sec:rw_sizing}) & \qty{\wheelT}{\milli\metre} \\
