...
\begin{enumerate}
  ...
  \item \textbf{Run the electrical and calibration checks} in order --- CAN-bus
        termination and rail voltages, then IMU and moteus calibration, then
        the gradual control-authority ramp --- against the validation stage
        gates of Section~\ref{sec:test_strategy}, before any unassisted
        balancing attempt.
