...
\begin{itemize}
    ...
    estimated rather than measured until the test pyramid closes. % Section~\ref{sec:test_paramid} closes.
...
measurement described in Section~\ref{sec:jumpup_target}: until the spin-down test
% of Section~\ref{sec:test_jumpup} 
reports both the impulse-equivalent mean
