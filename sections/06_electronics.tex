...
(Section~\ref{sec:test_strategy}), not repeated here.
...
Flight computer and IMU & Teensy 4.1 and BMI270 mounted at or as close as possible to the pivot, oriented per the body frame of Sec.~\ref{sec:cad_method} & Static orientation check; noise floor confirmed with wheels spinning \\
...
verification are listed in Table~\ref{tab:signal_rules} of
...
tracked against the validation stage gates of Section~\ref{sec:test_strategy}.
