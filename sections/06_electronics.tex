...
Encoder interfaces ($3\times$) & Short SPI run from each driver to its own encoder; encoder positions fix the driver positions, not the reverse & Air gap ${\le}\,\qty{0.5}{\milli\metre}$ confirmed; read-back with no error flags, re-checked after mechanical assembly \\
