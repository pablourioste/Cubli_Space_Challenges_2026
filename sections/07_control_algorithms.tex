...
noise and bias models set from the sensor characterisation of
Section~\ref{sec:sensor_cal} once measured, so that the same estimator and
control logic of Section~\ref{sec:pure_lqr_logic} --- not a re-implementation
of it --- runs against simulated sensor data in a controller-in-the-loop
configuration before it runs against real sensors.
