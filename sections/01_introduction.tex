...
% Naming convention, fixed here and used document-wide: "Cubli" is the platform
% class (ETH prior art), "Armonia" is the article this team builds. The project
% name itself comes from the identity block in main.tex, which the cover, the
% running header and the PDF metadata also read from.
The cube described in this document is \projectname{}, a Cubli of that class built to the requirements of Section~\ref{sec:requirements}. Throughout, \emph{Cubli} names the platform class and the body of work behind it, while \emph{\projectname{}} names the article built here; where a statement holds for any cube of the class it is written of the Cubli, and where it is a property of this build it is written of \projectname{}.
