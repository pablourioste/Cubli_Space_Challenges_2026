...
\paragraph{Technical objectives.} Each imposes a required capability. The
mapping below keeps every requirement traceable from motivation to capability,
...
Jump-up (stretch)   & The system must store sufficient wheel angular momentum and shed it near-impulsively through a braking event to tip itself from a face rest onto an edge or corner, and then capture the resulting attitude into balance. \\[0.5em]
