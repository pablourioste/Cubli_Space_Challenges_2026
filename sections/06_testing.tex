...
\begin{table}[h]
\centering
\caption{Validation stages. Exit gates refer to Table~\ref{tab:gates}; no gate
...
\begin{table}[h]
\centering
\caption{Pre-fabrication feasibility gate. Pass conditions are stated as
...
\begin{table}[h]
\centering
\caption{Electrical acceptance criteria. Task references are to the electrical
...
\begin{table}[h]
\centering
\caption{Plant parameters measured on the 1-DoF rig. Expected values follow from
...
\begin{table}[h]
\centering
\caption{Control performance metrics. Definitions and methods are fixed;
