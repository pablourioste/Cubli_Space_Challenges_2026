...
\midrule
1 & \textcolor{red}{TBD} & \textcolor{red}{TBD} & \textcolor{red}{TBD} \\
2 & \textcolor{red}{TBD} & \textcolor{red}{TBD} & \textcolor{red}{TBD} \\
3 & \textcolor{red}{TBD} & \textcolor{red}{TBD} & \textcolor{red}{TBD} \\
\bottomrule
\end{tabular}
\end{table}
...
far beyond the three angles of Table~\ref{tab:recovery_angle}.
\textcolor{red}{TODO: confirm the \qty{24}{\degree} recovery time and peak
current, and state whether this is the rig's mechanical limit (hard stop) or
simply the largest angle attempted so far.}
...
corner-balance case once edge balance is closed out, and compare against the
acceptance criteria of Table~\ref{tab:traceability} and the 1-DoF bench
results of Section~\ref{sec:test_1dof}.}
