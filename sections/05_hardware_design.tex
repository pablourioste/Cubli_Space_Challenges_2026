...
\begin{table}[htbp]
\centering
\caption[Mass budget (per cube)]{Mass budget (per cube). The total is an input to the inertia
...
listed in Table~\ref{tab:mech_interfaces}.%; the parts realising them, with their drawings, are in Appendix~\ref{app:cad_3d}.
