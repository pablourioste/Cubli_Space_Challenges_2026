...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.62\textwidth,angle=270]{images/cube_2D.jpeg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.55\textwidth,angle=270]{images/cube_3D.jpeg}
...
${\approx}\,\qty{60}{\ampere}$, which covers the \qty{48}{\ampere} three-axis
spin-up transient of Section~\ref{sec:power_arch} but with a smaller margin
than a \qty{90}{\ampere} housing would give, so the transient is a measured
acceptance item at first power-on rather than an assumed one. The bus
