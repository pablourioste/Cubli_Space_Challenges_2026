...
through the origin). Either way the \qty{5}{\newton\metre} brake torque of
Section~\ref{sec:massbudget} is two orders of magnitude beyond what one motor
can produce, which is why braking is a separate servo-actuated mechanism
rather than a motor function. Second, the highest measured point reaches
...
\caption{Measured MN4006 (a) shaft torque and (b) rotational speed against
