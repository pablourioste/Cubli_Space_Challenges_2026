...
budget and the fault responses --- will be collected, 
% is collected in
% Appendix~\ref{app:control_algorithms}
so that a re-tuned gain does not require
...
a stage. %The per-stage timing budget and its measured margin are recorded in Appendix~\ref{app:control_algorithms} and re-measured whenever a stage changes.
