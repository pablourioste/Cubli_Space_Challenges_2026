...
sizing must satisfy (Section~\ref{sec:objectives}), the physics that turns a
...
(Section~\ref{sec:massbudget}) and the wheel design that meets the resulting
target (Section~\ref{sec:rw_sizing}).
...
spin-down test, which should report both the
