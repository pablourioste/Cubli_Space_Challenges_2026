...
Section~\ref{sec:wbs} on the 23~July--3~August 2026 calendar, and
Table~\ref{tab:gates} states the gate that closes each phase. The critical path runs through the dynamics investigation and
