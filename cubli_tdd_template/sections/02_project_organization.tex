...
follows from it. The table below breaks the three streams into individual tasks, each with its
scope, owner and dates.
...
\begin{table}[h]
\centering
\caption{Milestone gates, from kick-off to the final presentation.}
\label{tab:gates}
\small
